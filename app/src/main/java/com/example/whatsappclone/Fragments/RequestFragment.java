...
public class RequestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reqFrag =  inflater.inflate(R.layout.fragment_request, container, false);
        ...
        recyclerView=reqFrag.findViewById(R.id.request_recyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        floatingActionButton = reqFrag.findViewById(R.id.request_float_btn);
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                builder.setTitle(receiverName+" 's Chat Requests");
                                                                        ...
                                                                        if (task.isSuccessful()) {
                                                                            ChatReqRef.child(list_of_users).child(CurrentUserID)
                                                                                    ...
                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                        ...
                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                            if (task.isSuccessful()) {
                                                                                                Toast.makeText(getContext(), "You have Canceled ", Toast.LENGTH_SHORT).show();
                                                                                            }
                                                                                        }
                                                                                    });
                                                                        }
